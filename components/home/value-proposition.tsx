              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-gray-950 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                    ...
                    , facing a myriad of challenges often unnoticed by society.
                    Amidst the bustling life, their{" "}
                    <span className="text-blue-600">
                      {" "}
              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-blue-600 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                    ...
                    We provide a platform where individuals can report mentally
                    disabled homeless people, initiating a powerful ripple
                    effect of change. By seamlessly connecting those in need
                    with NGOs dedicated to making a difference{" "}
                    <span className="text-blue-900">
